...
# CC Compiler Flags
CCFLAGS=-lopengl32 -lglu32 -lglew32 -lfreeglut -lassimp -lfreeimage
CXXFLAGS=-lopengl32 -lglu32 -lglew32 -lfreeglut -lassimp -lfreeimage
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practica4.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/practica4 ${OBJECTFILES} ${LDLIBSOPTIONS} -lopengl32 -lglu32 -lglew32 -lfreeglut -lassimp -lfreeimage -s
...
${OBJECTDIR}/src/Terrain.o: src/Terrain.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../libraries/includes -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Terrain.o src/Terrain.cpp
